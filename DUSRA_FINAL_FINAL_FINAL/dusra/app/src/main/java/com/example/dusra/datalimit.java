...
public class datalimit extends AppCompatActivity {
  ...
  private DocumentReference noteRef=db.collection(uid).document("data limit");
  @Override
        ...
        noteRef.set(note)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                  ...
                  public void onSuccess(Void aVoid) {
                    Toast.makeText(getApplicationContext(), "Data Limit has been set sucessfully!", Toast.LENGTH_SHORT).show();
                  }
                })
