...
String opaddress="";
    ...
    public  void  locatttt(String input){
...
//                Toast.makeText(MapsActivity.this,"Address is: "+opaddress,Toast.LENGTH_LONG).show();
                Log.e("adddressssssss",""+sss[3]);
                Log.e("adddressssssss",""+fetchedAddress.getFeatureName());
//                https://www.google.com/maps/search/doctor/@19.4079793,72.8420085,14z
                String geoUri = "https://www.google.com/maps/search/doctor/"+latlng[0]+","+latlng[1];
...
//            op.setText("ERROR GETTING ADDRESS");
    ...
    void near(String loca){
        String locc[]=loca.split(",");

        String url = getUrl(locc[0], locc[1], "Doctor");
        Object[] DataTransfer = new Object[2];
        DataTransfer[0] = map;
        DataTransfer[1] = url;
        Log.e("onClick", url);
        gettnearby getNearbyPlacesData = new gettnearby();
    ...
    private String getUrl(String latitude, String longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDRvbx3hB0Wh0HII8pWJ-92sk4XDt_jHiY");
