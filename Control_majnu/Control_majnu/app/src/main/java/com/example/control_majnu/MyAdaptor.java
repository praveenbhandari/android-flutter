...
public class MyAdaptor extends RecyclerView.Adapter<com.example.control_majnu.MyAdaptor.MyHolder>
{
     Context ct;
     ArrayList<Person> al;
     ...
     @Override
     public void onBindViewHolder(com.example.control_majnu.MyAdaptor.MyHolder holder , final int position)
     {
