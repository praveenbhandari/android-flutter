...
String assa="";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Bundle asss=getIntent().getExtras();
        ...
        if(asss.getString("loc")!= null)
        {
            Log.e("LOCCC",""+asss.getString("loc"));
        }
...
//                        if(getcity.equals(asss.getString("loc").trim()))
//                        {
                            ...
                            Log.e("eeee",""+dataloop.child("Name").getValue(String.class));
                            Log.e("eeee",""+dataloop.child("Id").getValue(String.class));
