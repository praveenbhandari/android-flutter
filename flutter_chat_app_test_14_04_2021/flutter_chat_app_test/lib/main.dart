  ...
  void login() {
    auth.signInWithEmailAndPassword(email: email.text, password: pass.text)
      ...
      // print(user.displayName);
       ...
       Navigator.push(context, MaterialPageRoute(builder: (context) => check_details())).catchError((onError)=>print("error"+onError));
      print("loggin");
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: FlatButton(
                          ...
                          child: Text("Login",style: TextStyle(fontSize: 30,color: Colors.black87),),
                        ),
                      ),
                ],
              ),
